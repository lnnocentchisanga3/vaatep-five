...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Child Profile Profile</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php include("childprofile.php"); ?></p>
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Child Progress record</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php include("childProgress.php"); ?></p>
	</div><!-- .toggle-content (end) -->
</div><!-- .toggle (end) -->
