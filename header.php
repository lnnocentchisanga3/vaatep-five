...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/logo.png" alt="" style="height: 51px;"><!-- <i class="fa fa-briefcase fa-2x"></i> VAATEP FIVE --></a> </div>
      <div class="head-info">
        <ul>
          <li> <i class="fa fa-phone"></i>
            <p>098478598438<br>
              9-269-690-VAATEP FIVE</p>
          </li>
          <li> <i class="fa fa-envelope-o"></i>
            <p>vaatepfive@gmail.com<br>
              info@vaatepfive.com</p>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>Chipokota Health Clinic<br>
             Ndola City</p>
          </li>
        </ul>
      </div>
    ...
    <!-- Nav -->
    <nav class="navbar ownmenu bg-dark">
      <div class="container">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Log In </a>
              <ul class="dropdown-menu multi-level" style="display: none;">
               ...
               <!--  <li><a href="doctorlogin.php">Doctor</a></li> -->
                <li><a href="parentlogin.php">Parents</a></li>  
              </ul>
            </li>           
          </ul>
        </div>
