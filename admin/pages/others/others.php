        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Record Immunization</h4>
                  ...
                  <div style="height: 35vh;" class="table-responsive">
                    ...
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                            <th>Action <br><span><small>(Click on the button to mark as given)</small></span></th>
                        </tr>
                    </thead>
                    <tbody id="searchedValues">
                        ...
                        if (mysqli_num_rows($query)==null) {
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            echo "<td id='immunize'><button class='btn btn-primary btn-sm' value='$row[childs_number]' onclick='addChildNum(this.value)'> Given </button></td>";
                            echo "</tr>";
                          }
                        }
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Record Vitamins</h4>
                  ...
                  <div class="card-description">
                   ...
                   <div class=" input-group">
                    <span class="bg-primary col-md-2 pt-3 text-center"><i class="ti-search menu-title text-white"></i></span>
                   <input type="text" name="search" id="searchChild" onkeyup="searchChild(this.value)" class="form-control col-md-12 bg-white" placeholder="Search by Child's Identity ID" autofocus>
                </div>
                  </div>
                    ...
                    <tbody id="searchedValues2">
                        ...
                        if (mysqli_num_rows($query)==null) {
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            echo "<td id='vitamin'><button class='btn btn-primary btn-sm' value='$row[childs_number]' onclick='addChildNum(this.value)'> Given </button></td>";
                            echo "</tr>";
                          }
                        }
                ...
                <script>
                     function searchChild(num){
                       ...
                       let xhttp;
                        ...
                        xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                          document.getElementById('searchedValues2').innerHTML = this.responseText;
                        } 
                        };
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class=" input-group my-2">
                   <input type="text" name="search" onkeyup="getChildByAjax(this.value)" class="form-control col-md-12 bg-white" placeholder="Search by Child's Identity ID" autofocus>
                   <span class="bg-primary col-md-2 pt-3 text-center"><i class="ti-search menu-title text-white"></i></span>
